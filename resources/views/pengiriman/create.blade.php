                ...
                <div class="card-body">
                    <form action="{{ route('pengiriman.store') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('daerah_pengiriman') is-invalid @enderror" id="daerah_pengiriman" name="daerah_pengiriman" value="{{ old('daerah_pengiriman') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('harga_pengiriman') is-invalid @enderror" id="harga_pengiriman" name="harga_pengiriman" value="{{ old('harga_pengiriman') }}">
