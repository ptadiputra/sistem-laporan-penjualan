            ...
            <div class="col-12">
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body">
                                ...
                                @foreach(old('barang_id') as $i => $barangId)
                                    <div class="barang-row row mb-3">
                                        <div class="col-md-3 mb-2">
                                            <label>Barang</label>
                                            <select class="form-control barang-select @error("barang_id.$i") is-invalid @enderror" name="barang_id[]">
                                                <option value="">Pilih Barang</option>
                                                @foreach($barangs as $barang)
                                                    <option value="{{ $barang->id }}" data-harga="{{ $barang->harga }}" {{ $barangId == $barang->id ? 'selected' : '' }}>{{ $barang->nama }}</option>
                                                @endforeach
                                            </select>
                                            @error("barang_id.$i")
                                        ...
                                        <div class="col-md-2 mb-2">
                                            <label>Jumlah</label>
                                            <input type="number" class="form-control qty-input @error("qty_barang.$i") is-invalid @enderror" name="qty_barang[]" value="{{ old('qty_barang')[$i] ?? 0 }}">
                                            @error("qty_barang.$i")
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-3 mb-2">
                                            ...
                                            <input type="number" class="form-control harga-satuan" name="harga_satuan_barang[]" value="{{ old('harga_satuan_barang')[$i] ?? 0 }}" readonly>
                                        </div>
                        
                                        <div class="col-md-3 mb-2">
                                            <label>Harga Total</label>
                                            <input type="number" class="form-control harga-total" name="harga_total[]" value="{{ old('harga_total')[$i] ?? 0 }}" readonly>
                                        </div>
                        ...
                        <button type="button" id="add-barang" class="btn btn-primary mb-3"><i class="fas fa-plus"></i> Tambah Barang</button>
                        <hr>
                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('biaya_pengiriman') is-invalid @enderror" id="biaya_pengiriman" name="biaya_pengiriman" value="{{ old('biaya_pengiriman', 0) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('diskon') is-invalid @enderror" id="diskon" name="diskon" value="{{ old('diskon', 0) }}">
                            @error('diskon')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('alamat_pengiriman') is-invalid @enderror" name="alamat_pengiriman" id="alamat_pengiriman" cols="30" rows="3">{{ old('alamat_pengiriman') }}</textarea>
