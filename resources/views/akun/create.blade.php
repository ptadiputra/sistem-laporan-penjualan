                    ...
                    <form action="{{ route('akun.store') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('kelompok') is-invalid @enderror" id="kelompok" name="kelompok">
                                ...
                                <option value="Aset/Aktiva" @selected(old('kelompok') == 'Aset/Aktiva')>Aset/Aktiva</option>
                                <option value="Liabilitas" @selected(old('kelompok') == 'Liabilitas')>Liabilitas</option>
                                ...
                                <option value="Modal" @selected(old('kelompok') == 'Modal')>Modal</option>
                                <option value="Prive" @selected(old('kelompok') == 'Prive')>Prive</option>
                                <option value="Kas" @selected(old('kelompok') == 'Kas')>Kas</option>
                                <option value="Other" @selected(old('kelompok') == 'Other')>Other</option>
                            </select>
                            @error('kelompok')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('normal_post') is-invalid @enderror" id="normal_post" name="normal_post">
                                <option value="">Pilih Normal Post</option>
                                <option value="debit" {{ old('normal_post') == 'debit' ? 'selected' : '' }}>debit</option>
                                <option value="kredit" {{ old('normal_post') == 'kredit' ? 'selected' : '' }}>kredit</option>
                            </select>
                            @error('normal_post')
                                <div class="invalid-feedback">
                                    {{ $message }}
