                ...
                <div class="card-body">
                    <form action="{{ route('user.update', $user->id) }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('no_tlp_user') is-invalid @enderror" id="no_tlp_user" name="no_tlp_user" value="{{ old('no_tlp_user', $user->no_tlp_user) }}">
                            @error('no_tlp_user')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <small class="form-text text-muted">Isi bidang ini jika ingin mengubah password.</small>
                            @error('password')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-group">
                            <label for="role">Normal Post</label>
