    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                    <form action="{{ route('jurnal-entry.store') }}" method="post">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('debit') is-invalid @enderror" id="debit" name="debit" value="{{ old('debit',0) }}">
                            @error('debit')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('kredit') is-invalid @enderror" id="kredit" name="kredit" value="{{ old('kredit',0) }}">
                            @error('kredit')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
